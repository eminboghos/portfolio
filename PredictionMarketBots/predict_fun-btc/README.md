...
4. Update quotes in under 400ms whenever Bitcoin moves
...
As the 5-minute markets were implemented recently, they remain in the testing phase. I initially underestimated the impact of heightened volatility, which is reflected in the recent PnL dip shown in the [PnL graphs](./results.md).
